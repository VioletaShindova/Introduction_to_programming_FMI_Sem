//// ReturnArrayWithExactLength_Ex1.cpp : This file contains the 'main' function. Program execution begins and ends there.
////
//
//#include <iostream>
//using namespace std;
...
//	}
//
//	unsigned resultSize = myStrlen(str);
//}
//
//int main()
//{
