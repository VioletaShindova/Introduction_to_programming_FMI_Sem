// Sem.04_Ex4.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
bool isSuffix(unsigned firstNumber, unsigned secondNumber)
{
...
int main()
{
    ...
    if (isSuffix(firstNumber, secondNumber))
    {
        cout << "True";
    }
    else
